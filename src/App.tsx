...
function App() {
  ...
  return (
    <div
      className={`${darkModeTheme ? "bg-slate-950 text-neutral-50 selection:bg-slate-600 selection:text-neutral-50" : "bg-slate-50 text-neutral-900 selection:bg-slate-400 selection:text-neutral-50"} w-full min-h-screen`}
    >
      <button
